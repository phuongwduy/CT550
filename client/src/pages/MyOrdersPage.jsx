...
function MyOrdersPage() {
  ...
  <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
    <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-green-700 text-center flex items-center justify-center gap-2">
      ...
      <div className="space-y-6 sm:space-y-8">
        {filteredOrders.map((order) => {
          ...
          return (
            <div
              key={order.id}
              className={`bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition p-4 sm:p-6 border-l-4 ${info.left}`}
            >
              {/* Header */}
              <div className="flex flex-wrap justify-between items-start mb-4 sm:mb-5">
                <div>
                ...
                <div
                  className={`flex items-center gap-2 px-3 py-1 rounded-full text-xs sm:text-sm font-medium ${info.color}`}
                >
                  <Icon size={18} />
              ...
              {/* Info Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-sm text-gray-700 mb-4">
                <div>
              ...
              {/* Footer */}
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-t pt-3 sm:pt-4 gap-3 sm:gap-0">
